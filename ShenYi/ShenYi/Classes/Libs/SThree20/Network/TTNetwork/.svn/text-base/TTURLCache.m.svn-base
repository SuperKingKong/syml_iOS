...
static        NSString* kDefaultCacheName       = @"sohumtc";
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (NSString*)cachePathWithName:(NSString*)name {
    return [SThree20Extral cachePathWithName:name];
    /*
...
- (NSString *)keyForURL:(NSString*)URL {
	return [SThree20Extral md5Hash:URL];
}
...
{
    return [SThree20Extral sharedDocsCache];
}

+ (TTURLCache *)sharedUsrCache
{
    return [SThree20Extral sharedUsrCache];
}

+ (TTURLCache *)sharedImgsCache
{
    return [SThree20Extral sharedImgsCache];
}
+ (TTURLCache *)sharedAudioCache
{
    return [SThree20Extral sharedAudioCache];
}
